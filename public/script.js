...
const jsonQuestions = [
  ...
  // Ajoutez d'autres questions sur JSON
];
...
const ajaxQuestions = [
  ...
  // Ajoutez d'autres questions sur AJAX si nécessaire
];


const webSocketQuestions = [
  {
  ...
  // ... Ajoutez d'autres questions sur les WebSockets si nécessaire
];
...
const jqueryQuestions = [
  ...
  // Ajoutez d'autres questions sur jQuery si nécessaire
];
...
const quizData = [...htmlQuestions, ...cssQuestions, ...jsQuestions, ...jsonQuestions, ...ajaxQuestions, ...webSocketQuestions,...jqueryQuestions  ];
